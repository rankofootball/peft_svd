...
#            )
        ...
        if init_lora_weights == "pissa":
            ...
            #Vr = V[:, : self.r[adapter_name]]     # dim output,r
            #Sr = S[: self.r[adapter_name]]        #     r,r
...
#            v_truncated = v[:self.r[adapter_name],:]    # uncomment for variant 1
        ...
        # variant 1 with constrained input space
#        lora_A = v_truncated
